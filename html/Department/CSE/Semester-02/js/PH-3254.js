...
let unit_text1 = ` Classical free electron theory - Expression for electrical conductivity - Thermal conductivity
expression - Wiedemann Franz law - electrons in metals - Particle in a
...
let unit_text2 = ` Intrinsic Semiconductors - Energy band diagram - direct and indirect band gap semiconductors -
Carrier concentration in intrinsic semiconductors - extrinsic semiconductors - Carrier concentration
in N type - Carrier concentration P type semiconductors - Variation of carrier concentration with temperature - variation
of Fermi level with temperature and impurity concentration - 
random motion,drift, mobility and diffusion - Hall effect and devices - Ohmic contacts - Schottky
diode *`;

let unit_text3 = ` Magnetic dipole moment - atomic magnetic moments- magnetic permeability and susceptibility - diamagnetism - paramagnetism - ferromagnetism -
...
magnetic materials - Magnetic principle in computer data storage - Magnetic
hard disc (GMR sensor).`;

let unit_text4 = ` Classification of optical materials - carrier generation and recombination processes - Absorption
emission and scattering of light in metals -  insulators and semiconductors  - photo
current in a P N diode - solar cell - LED - Organic LED - Laser diodes - Optical data storage
techniques `;

let unit_text5 = ` quantum confinement -  quantum wells ,wires , dots - band
gap of nanomaterials - Tunneling - Single electron phenomena: Coulomb blockade - resonant Tunneling diode - single electron transistor - quantum cellular automata - Quantum system for
information processing - quantum states - classical bits - quantum bits or qubits - CNOT gate -
multiple qubits - Bloch sphere - quantum gates  `;
