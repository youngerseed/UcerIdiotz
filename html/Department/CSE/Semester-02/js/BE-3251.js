...
let unit_text1 = "Conductor -  Resistor - Inductor - Capacitor - Ohm’s Law - Kirchhoff’s Laws -  Nodal Analysis-  Mesh analysis -  Waveforms - RMS Value - Instantaneous power - real power - reactive power - apparent power - power factor - Steady state analysis of RLC circuits";

let unit_text2 = "Self excited Generators- EMF equation & Types and Applications - Working Principle of DC motors - Torque Equation -  Working principle and Applications of Transformer -  Three phase Alternator - Synchronous motor -  Three Phase Induction Motor";

let unit_text3 = " Resistor - Inductor - Capacitor in Electronic Circuits-  Silicon  Germanium - PN Junction Diodes - Zener Diode - Bipolar Junction Transistor - Biasing -JFET -SCR -MOSFET -IGBT - Rectifier - Inverters";

let unit_text4 = " Review of number systems - binary codes -  error detection  correction codes - Combinational logic- representation of logic functions-SOP and POS forms -  K map representations - minimization using K maps ";

let unit_text5 = "Standards and calibration -  Operating Principle - Moving Coil  Moving Iron meters - Measurement of three phase power -  Energy Meter - Instrument Transformers CT - Instrument Transformers PT -  DSO - Block diagram - Data acquisition";
