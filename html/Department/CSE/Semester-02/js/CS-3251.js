...
let unit_text1 = `Applications of C Language - Structure of C program -  Data Types - Constants - Enumeration Constants - Keywords - 
...
let unit_text2 = ` Arrays Declaration - Arrays Initialization - One dimensional array -Two dimensional
arrays - String Operations In C - Selection sort - linear earch - binary search`;

let unit_text3 = `Modular programming - Function prototype c - function definition c - function call c - C Built-in functions (string
    functions, math functions) - Recursion In C  -  Binary Search using recursive functions C  - Pointers In C -
    Pointer operators In C - Pointer arithmetic in C - Arrays and pointers In C - Array of pointers In C -
    Pass by value in C -  Pass by reference in C`;

let unit_text4 = `Structure - Nested structures - Pointer and Structures - Array of structures - Self referential
structures - Dynamic memory allocation - Singly linked list - typedef - Union - Storage classes and
Visibility `;

let unit_text5 = `Files  in C - Types of file processing in c-  Sequential access In C -  Random access in C -  Sequential access file C - Random access file C - Command line arguments C`;
