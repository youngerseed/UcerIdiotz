...
let unit_text1 = "Relation to Computer System Components - Message Passing Systems - Shared Memory Systems - Primitives for Distributed Communication -Synchronous Executions - Asynchronous Executions - A Distributed Program - A Model of Distributed Executions - Models ofCommunication Networks - Global State of a Distributed System";

let unit_text2 = "Logical Time- Physical Clock Synchronization- NTP - A Framework for a System of Logical Clocks- Scalar Time - Vector Time-Message Ordering and Group Communication- Message Ordering Paradigms - Asynchronous Execution with Synchronous Communication - Synchronous Program Order on Asynchronous System - Group Communication - Causal Order - Total Order- GlobalState Algorithms - Snapshot Recording Algorithms - System Model - Definitions - Snapshot Algorithms for FIFO Channels";

let unit_text3 = " Distributed Mutual exclusion Algorithms-  Preliminaries - Lamport’s algorithm - RicartAgrawala’s Algorithm - Token Based Algorithms - Suzuki-Kasami’s Broadcast Algorithm-Deadlock Detection in Distributed Systems-  System Model - Preliminaries - Modelsof Deadlocks - Chandy Misra Haas Algorithm - AND model - OR Model";

let unit_text4 = " Consensus and Agreement Algorithms - Agreement in a Failure Free System - Agreement in Synchronous Systems with Failures- Checkpointing and Rollback Recovery- Background and Definitions - Issues in Failure Recovery - Checkpoint based Recovery - Coordinated Checkpointing Algorithm - Algorithm for Asynchronous Checkpointing and Recovery ";

let unit_text5 = "Definition of Cloud Computing - Characteristics of Cloud - Cloud Deployment Models - CloudService Models - Virtualization - Load Balancing -Scalability and Elasticity - Replication - Monitoring - Cloud Services and Platforms - ComputeServices - Storage Services - Application Services";
