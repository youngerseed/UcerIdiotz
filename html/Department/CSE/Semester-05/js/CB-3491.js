...
let unit_text1 = "Computer Security Concepts-The OSI Security Architecture-Security Attacks-Security Services Mechanisms-A Model for Network Security-Classical encryption techniques- Substitution techniques- Transposition techniques- Steganography-Foundations of modern cryptography- Perfect security-Information Theory-Product Cryptosystem-Cryptanalysis";

let unit_text2 = "Number theory-Algebraic Structures-Modular Arithmetic - Euclid's algorithm-Congruence and matrices-SYMMETRIC KEY CIPHERS- SDES Block Ciphers DES- Strength of DES Differential - linear cryptanalysis-Block cipher design principles-Block cipher mode of operation-Evaluation criteria for AES-Pseudorandom Number Generators-RC4 Key distribution";

let unit_text3 = "Primes - Primality Testing -  Factorization - Euler’s totient function- Fermat’s Theorem  - Euler’s Theorem - Chinese Remainder Theorem - Exponentiation and logarithm  ASYMMETRIC KEY CIPHERS: RSA cryptosystem - Key distribution - Key management - Diffie  Hellman key exchange* - Elliptic curve arithmetic - Elliptic curve cryptography. "

let unit_text4 = "Primes Primality - Testing  Factorization-Euler’s totient function- Fermat’s and Euler’s Theorem-Chinese Remainder Theorem- RSA cryptosystem-Key distribution-Key management-Diffie Hellman key exchange - Elliptic curve arithmetic-Elliptic curve cryptography- Authentication requirement-Authentication function– MAC Hash function- HMAC- CMAC-SHA-Digital signature and authentication protocols-DSS-Schnorr Digital Signature Scheme-ElGamal cryptosystem-Entity Authentication- Biometrics- Passwords- Challenge Response protocols-Authentication applications-Kerberos MUTUAL TRUST- Key management and distribution-Symmetric key distribution using symmetric - asymmetric encryption Distribution of public keys- X.509 Certificates. ";

let unit_text5 = "Cyber Crime and Information Security-classifications of Cyber Crimes-Tools and Methods-Password Cracking- Keyloggers- Spywares- SQL Injection-Network Access Control-Cloud Security-Web Security-Wireless Security";
