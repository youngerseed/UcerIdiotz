...
// todo  function for loop the topics and add to html
...
let unit_text1 = "Data Communication - Networks - Network Types - Protocol Layering - TCP/IP Protocol suite - OSI Model - Introduction to Sockets - Application Layer protocols: HTTP - FTP - Email protocols SMTP protocols - POP3 protocols - IMAP protocols - MIME - DNS - SNMP";

let unit_text2 = "Transport-Layer Protocols- UDP - TCP- Connection Management - Flow control - Congestion Control - Congestion avoidance (DECbit, RED) - SCTP - Quality of Service";

let unit_text3 = "Switching - Packet Switching - Internet protocol - IPV4 - IP Addressing - Subnetting - IPV6- ARP- RARP- ICMP- DHCP "

let unit_text4 = "Routing and protocols- Unicast routing - Distance Vector Routing - RIP - Link State Routing - OSPF - Path-vector routing - BGP - Multicast Routing- DVMRP - PIM. ";

let unit_text5 = "Data Link Layer - Framing - Flow control - Error control - Data Link Layer Protocols - HDLC -PPP - Media Access Control - Ethernet Basics - CSMA|CD - Virtual LAN - Wireless LAN (802.11) - Physical Layer- Data and Signals - Transmission media- Switching -Circuit Switching";
