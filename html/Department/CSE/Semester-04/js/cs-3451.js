...
let unit_text1 = `  Operating System Overview - Objectives and
...
let unit_text2 = ` Processes - Process Concept - Process Scheduling - Operations on Processes - Inter-process
...
let unit_text3 = ` Main Memory - Swapping - Contiguous Memory Allocation - Paging - Structure of the Page Table -
Segmentation OS -  Segmentation with pagin -  Virtual Memory - Demand Paging - Copy on Write - Page
Replacement - Allocation of Frames -Thrashing `;

let unit_text4 = `Mass Storage system - Disk Structure - Disk Scheduling and Management -File-System Interface -
...
implementation - Allocation Methods - Free Space Managemen-  IO Systems - IO Hardware-
Application IO interface - Kernel IO subsystem `;

let unit_text5 = ` Virtual Machines - History,Benefits and Features - Types of Virtual Machines -
their Implementations of VM's, Virtualization - Operating-System Components - Mobile OS - iOS and
Android. `;
