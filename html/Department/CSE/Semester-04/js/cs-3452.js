...
let unit_text1 = ` Need for automata theory - Introduction to formal proof - Finite Automata (FA) - Deterministic Finite
...
with and without εmoves - Conversion of NFA into DFA - Minimization of DFAs `;

let unit_text2 = ` Regular expression - Regular Languages- Equivalence of Finite Automata and regular expressions
-  Pumping Lemma  - Closure properties of regular languages `;

let unit_text3 = ` Types of Grammar TOC - Chomsky‘s hierarchy of languages -Context Free Grammar (CFG) and
Languages - Derivations and Parse trees - Ambiguity in grammars and languages - Push Down
Automata (PDA)-  Instantaneous descriptions - Languages of pushdown
automata - Equivalence of pushdown automata and CFG -CFG to PDA -P DA to CFG - Deterministic
Pushdown Automata `;

let unit_text4 = ` Normal forms for CFG - Simplification of CFG- Chomsky Normal Form (CNF) -Greibach Normal
Form (GNF) - Pumping lemma for CFL - Closure properties of Context Free Languages -Turing
Machine - TM Basic model - TM definition and representation - Instantaneous Description - Language
acceptance by TM - TM as Computer of Integer functions - Programming techniques for Turing
machines (subroutines) `;

let unit_text5 = ` Unsolvable Problems and Computable Functions - PCP - MPCP- Recursive and recursively
enumerable languages - Universal Turing machine - Tractable and Intractable problems 
