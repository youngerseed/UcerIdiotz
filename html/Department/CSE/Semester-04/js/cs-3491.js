...
let unit_text1 = ` AI Applications - Problem solving agents - search algorithms - uninformed
...
let unit_text3 = ` Linear Regression Models- Least squares - single  multiple
...
let unit_text4 = ` Combining multiple learners - Model combination schemes - Voting  Ensemble Learning - bagging,
boosting, stacking - Unsupervised learning -K means -Instance Based Learning - KNN- Gaussian
mixture models  `;

let unit_text5 = ` Perceptron - Multilayer perceptron -  activation functions -  network training - gradient descent
