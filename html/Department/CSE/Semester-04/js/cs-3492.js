...
let unit_text1 = ` Purpose of Database System - Views of data - Data Models - Database System Architecture -
relational databases - Relational Model - Keys in DBMS - Relational Algebra - SQL
fundamentals - Advanced SQL features - Embedded SQL- Dynamic SQL `;

let unit_text2 = ` Entity-Relationship model - ER Diagrams - Enhanced  ER Model - ER to Relational Mapping -
Functional Dependencies - Non loss Decomposition - First, Second, Third Normal Forms -
Dependency Preservation - Boyce Codd Normal Form - Multi valued Dependencies - Fourth
Normal Form - Join Dependencies - Fifth Normal Form `;

let unit_text3 = ` Transaction Concepts - ACID Properties* - Schedules - Serializability - Transaction support in SQL
- Need for Concurrency - Concurrency control -Two Phase Locking- Timestamp - Multiversion -
Validation  Snapshot isolation- Multiple Granularity locking - Deadlock Handling - Recovery
Concepts - Recovery based on deferred and immediate update - Shadow paging - ARIES
Algorithm `;

let unit_text4 = ` RAID - File Organization - Organization of Records in Files - Data dictionary Storage - Column
Oriented Storage- Indexing and Hashing - Ordered Indices - B+ tree Index Files* - B tree Index Files
- Static Hashing - Dynamic Hashing - Query Processing Overview - - Query optimization using Heuristics* - Cost Estimation `;

let unit_text5 = ` Distributed Databases - Distributed Databases Architecture -Distributed Databases Data Storage - Distributed Databases Transaction Processin - Query processing and
optimization - NOSQL Databases -  CAP Theorem - Document Based systems - Key
value Stores - Column Based Systems - Graph Databases - Database Security -  Security issues DBMS -
Access control based on privileges - Role Based access control - SQL Injection* - Statistical
Database security - Flow control - Encryption and Public Key infrastructures `;
