...
let unit_text1 = ` Algorithm analysis: Time and space complexity - Asymptotic Notations
case, Worst case , average case analysis - Recurrence relation -  substitution method - Lower
bounds -  linear search- binary search - Interpolation Search - The
naïve string - matching algorithm - Rabin Karp algorithm - Knuth Morris Pratt algorithm - 
Insertion sort - heap sort `;

let unit_text2 = `Representations of graphs -  DFS - BFS - 
Connectivity, strong connectivity -  bi-connectivity - Minimum spanning tree - Kruskal’s algorithm- Prim’s
algorithm-  Bellman Ford algorithm - Dijkstra’s algorithm - Floyd Warshall algorithm-
 Flow networks - Ford Fulkerson method -Maximum bipartite matching `;

let unit_text3 = ` Divide and Conquer methodology - Finding maximum and minimum - Merge sort - Quick sort - Elements of dynamic programming - Matrix chain multiplication* - Multi
...
let unit_text4 = ` n-Queens problem - Hamiltonian Circuit Problem - Subset Sum Problem - Graph
...
let unit_text5 = ` Tractable and intractable problems - Polynomial time algorithms - Venn diagram representation -
NP algorithms - NP hardness - NP completeness - Bin Packing problem - 
TSP - 3 CNF problem-  TSP  - primality testing - randomized quick sort - Finding kth smallest number `;
