...
let unit_text1 = "Sources and impurities - Water quality parameters: Definition and significance of-color - odour - turbidity - pH - hardness - alkalinity -  TDS, COD and BOD - fluoride and arsenic - Municipal water treatment - primary treatment - disinfection (UV, Ozonation, break-point chlorination)- Reverse Osmosis - Boiler troubles -  Scale and sludge - Boilercorrosion - Caustic embrittlement - Priming & foaming - Treatment of boiler feed water:Internaltreatment (phosphate, colloidal, sodium aluminate and calgon conditioning) - External treatment - Ion exchange demineralization - zeolite process";

let unit_text2 = "Distinction between molecules - nanomaterials - bulk materials - Size Dependent -properties (optical, electrical, mechanical and magnetic) - Types of nanomaterials - Definition,properties and uses of - nanoparticle - nanocluster -  nanorod -  nanowire and nanotube - Preparationof nanomaterials: sol-gel, solvothermal, laser ablation, chemical vapour deposition - electrochemical deposition - electro spinning -  Applications of nanomaterials in medicine - agricultur - electronics and catalysis";

let unit_text3 = " One component system - water system - Reduced phase rule - Construction of a simple eutectic phase diagram - Thermal analysis -  lead-silver system - Pattinson process -  Definition & Need for composites- Constitution - Matrix materials (Polymermatrix, metal matrix and ceramic matrix) - Reinforcement (fiber, particulates, flakes andwhiskers) - Properties and applications of: Metal matrix composites (MMC) - Ceramic matrixcomposites - Polymer matrix composites- Hybrid composites ";

let unit_text4 = " Classification of fuels; Coal and coke - Analysis of coal (proximate and ultimate)- Carbonization - Manufacture of metallurgical coke (Otto Hoffmann method) - Petroleum and Diesel:Manufacture of synthetic petrol (Bergius process), Knocking - octane number, diesel oil - cetanenumber - Power alcohol and biodiesel - Combustion of fuels -  Calorific value - higher and lower calorific values - Theoreticalcalculation of calorific value - Ignition temperature - spontaneous ignition temperature -  Flue gas analysis - ORSAT Method - CO2 emission & carbon footprint.";

let unit_text5 = "mass defect (problems) - binding energy -  Nuclear energy - light water nuclearpower plant - breeder reactor - Solar energy conversion - Principle, working and applications of solarcells - Recent developments in solar cell materials -  Wind energy - Geothermal energy - Batteries:Types of batteries - Primary battery - dry cell, Secondary battery - lead acid battery and lithium-ion-battery - Electric vehicles - working principles - Fuel cells - H2-O2 fuel cell - microbial fuel cell - Supercapacitors: Storage principle  types and examples";
