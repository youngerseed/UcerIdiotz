...
let unit_text1 = "Center of mass  - CM of continuous bodies - motion of the CM - kinetic energy of the system of particles - Rotational kinematics - rotational kinetic energy - moment of inertia - theorems of MI - moment of inertia of continuous bodies - M.I of a diatomic molecule - torque - rotational dynamics of rigid bodies - conservation of angular momentum - rotational energy state of a rigid diatomic molecule - gyroscope - torsional pendulum - double pendulum -  nonlinear oscillations";

let unit_text2 = "The Maxwell's equations - electromagnetic waves speed - electromagnetic waves amplitude - electromagnetic waves phase - electromagnetic waves orientation -electromagnetic waves waves in matter - polarization - Producing electromagnetic waves - Cell-phone reception - Reflection - transmission of electromagnetic waves from a non-conducting medium - vacuum interface for normal incidence";
...
let unit_text5 = "The harmonic oscillator- Barrier penetration - quantum tunneling- Tunneling microscope - Resonant diode - Finite potential wells - Bloch's theorem for particles in a periodic potential - Basics of Kronig_Penney model - origin of energy bands";
