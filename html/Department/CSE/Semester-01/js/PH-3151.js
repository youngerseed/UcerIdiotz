...
let unit_text1 = "Center of mass (CM) - CM of continuous bodies - motion of the CM - kinetic energy of the system of particles - Rotational kinematics - rotational kinetic energy and moment of inertia - theorems of MI -moment of inertia of continuous bodies - M.I of a diatomic molecule - torque - rotational dynamics of rigid bodies - conservation of angular momentum - rotational energy state of a rigid diatomic molecule - gyroscope - torsional pendulum - double pendulum -  nonlinear oscillations";

let unit_text2 = "The Maxwell’s equations - wave equation; Plane electromagnetic waves in vacuum, Conditions on the wave field - properties of electromagnetic waves: speed, amplitude, phase, orientation & waves in matter - polarization - Producing electromagnetic waves - Cell-phone reception - Reflection and transmission of electromagnetic waves from a non-conducting medium - vacuum interface for normal incidence";
...
let unit_text5 = "The harmonic oscillator(qualitative)- Barrier penetration and quantum tunneling(qualitative)- Tunneling microscope - Resonant diode - Finite potential wells (qualitative)- Bloch’s theorem for particles in a periodic potential - Basics of Kronig-Penney model and origin of energy bands";
