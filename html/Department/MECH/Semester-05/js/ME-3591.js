...
let unit_text1 = "factors influencing machine design- selection of materials based on mechanical properties - Preferred numbers- Direct, Bending and torsional loading- Modes of failure - Factorof safety - Combined loads - Principal stresses - Eccentric loading - curved beams - crane hook and C frame- theories of failure - Design based on strength and stiffness - stress concentration - Fluctuating stresses - Endurance limit -Design for finite and infinite life under variable loading - Exposure to standards";

let unit_text2 = "Shafts and Axles - Design of solid - hollow shafts  - Keys and splines - Rigid and flexible couplings";

let unit_text3 = "Threaded fasteners - Bolted joints including eccentric loading- Knuckle joints- Cotter joints - Welded jointsButt- Fillet parallel transverse fillet welds - welded joints subjected to bending- torsional ,eccentric loads- riveted joints for structures - theory of bonded joints "

let unit_text4 = "Types of springs- design of helical -concentric springs-surge in springs- Design of laminated springs - rubber springs - Flywheels considering stresses in rims and arms for engines and punching machines- Solid  flywheels - Rimmed flywheels- connecting rods-crank shafts";

let unit_text5 = "Sliding contact -rolling contact bearings - Hydrodynamic journal bearings- Sommerfeld Number- Raimondi - Boyd graphs- Selection of Rolling Contact bearings -Design of Seals - Design of Gaskets";
