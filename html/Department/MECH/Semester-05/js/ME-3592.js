...
let unit_text1 = "Measurement – Need, Process, Role in quality control- Factors affecting measurement - SWIPE- Errors in Measurements - Measurement uncertainty - Types, Estimation, Problems on Estimation of Uncertainty- Statistical analysis of measurement data- Measurement system analysis- Calibration of measuring instruments- Principle of air gauging- ISO standards" ;

let unit_text2 = "Linear Measuring Instruments - Vernier caliper- Micrometer- Vernier height gauge- Depth Micrometer- Bore gauge- Telescoping gauge- Gauge blocks - Use and precautions- Comparators - Working and advantages- Opto-mechanical measurements using measuring microscope and Profile projector - Angular measuring instruments - Bevel protractor- Clinometer- Angle gauges- Precision level- Sine bar- Autocollimator- Angle dekkor- Alignment telescope. Measurement of Screw threads - Single element measurements - Pitch Diameter- Lead Pitch- Measurement of Gears - purpose - Analytical measurement - Runout- Pitch variation- Tooth profile- Tooth thickness Lead - Functional checking - Rolling gear test" ;

let unit_text3 = "Tolerancing- Interchangeability- Selective assembly- Tolerance representation-Terminology-Limits and Fits-Design of Limit gauges- Tolerance analysis in manufacturing- Process capability- tolerance stackup- tolerance charting." ;

let unit_text4 = " Fundamentals of GD & T- Conventional tolerance- Geometric tolerance- Datums- Inspection of geometric deviations like straightness- flatness- roundness deviations-  Measurement of Surface finish - Functionality of surfaces- Stylus based and Optical Measurement techniques- Introduction to 3D surface metrology " ;

let unit_text5 = " Lasers in metrology - Advantages of lasers - Laser scan micrometers- Laser interferometers - Applications - Straightness Alignment- Ball bar tests- Computer Aided Metrology - Basic concept of CMM - Types of CMM – Constructional features - Probes - Accessories -Software Applications - Multisensor CMMs- Machine Vision - Basic concepts of Machine Vision System  - Online and inprocess monitoring in production - Computed tomography – White light Scanners " ;
