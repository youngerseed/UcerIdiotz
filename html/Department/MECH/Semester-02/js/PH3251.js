...
let unit_text1 = ` Crystal structures: BCC, FCC and HCP - directions and planes - linear and planar densities - crystal
...
let unit_text2 = ` Classical free electron theory - Expression for electrical conductivity - Thermal conductivity,
...
let unit_text3 = ` Intrinsic Semiconductors - Energy band diagram - direct and indirect band gap semiconductors -
...
transport in Semiconductors- Drift  mobility  diffusion - Hall effect  - Ohmic contacts
- Schottky diode `;

let unit_text4 = ` Classification of optical materials - Optical processes in semiconductors- optical absorption and
...
- nonlinear optics- Modulators - switching devices - plasmonics `;

let unit_text5 = ` Quantum confinement - Quantum structures - quantum wells- wires and dots - Zener-Bloch
oscillations - Resonant tunneling - quantum interference effects - mesoscopic structures - Single
electron phenomena - Single electron Transistor- Semiconductor photonic structures - 1D photonic crystal - 2D photonic crystal -
