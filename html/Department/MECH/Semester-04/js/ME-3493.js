...
let unit_text1 = `Mechanics of chip formation- forces in machining- Types of chip- cutting tools - single point cutting tool nomenclature- orthogonal and oblique metal cutting- thermal aspects- cutting tool materials- tool wear- tool life- surface finish - cutting fluids and Machinability`;

let unit_text2 = `Centre lathe - constructional features- specification- operations taper turning methods- thread cutting methods- special attachments- surface roughness in turning- machining time and power estimation- Special
lathes - Capstan and turret lathes - tool layout - automatic lathes: semi-automatic - single spindle Swiss
type - single spindle automatic screw type - single spindle multi spindle`;

let unit_text3 = `Reciprocating machine tools shaper - Reciprocating machine tools planer - slotter Types and operations- Hole making Drilling - Hole making reaming - Hole making boring - Hole making tapping - Hole making type of milling operations attachments - types of milling cutters - machining time calculation
- Gear cutting - gear hobbing and gear shaping - gear finishing methods Abrasive processes grinding wheel - specifications and selection - types of grinding process - cylindrical grinding - surface grinding - centreless
grinding - internal grinding - micro finishing methods`;

let unit_text4 = `Computer Numerical Control machine tools - CNC constructional details - CNC special features - CNC Drives - Recirculating ball screws - CNC Control systems Open/closed - point-to-point/continuous -
Turning and machining centres - Work holding methods in Turning and machining centres - Coolant systems -
Safety features`;

let unit_text5 = `Coordinates - axis and motion - Absolute vs Incremental - Interpolators - Polar coordinates - Program planning - G and M codes - CNC machining centers and Turning centers - Fixed cycles - Loops and subroutines - Setting up a CNC machine for machining`;
