...
let unit_text1 = ` Principles of heat transfer- steady state of heat flow- conduction through compound media-series
and parallel-conductivity of rubber tube -powder materials - heat transfer through fenestrations-
thermal insulation and its benefits - heat gain - heat loss estimation - factors affecting the thermal
performance of buildings- thermal measurements- thermal comfort- indices of thermal comfort-
climate - design of solar radiation- shading devices - central heating. `;

let unit_text2 = ` principles of natural ventilation - ventilation measurements- design for natural
ventilation - Window types - packaged air conditioners - chilled water plant - fan coil systems -
water piping - cooling load - Air conditioning systems for different types of buildings  `;

let unit_text3 = ` Methods of sound absorptions - absorbing materials - noise and its measurements- sound insulation
and its measurements- impact of noise in multistored buildings- Visual field glare- colour - day light
calculations - day light design of windows- principles of artificial lighting- supplementary artificial lighting.`;

let unit_text4 = ` Composites - Definition  Classification - Fibre reinforced plastics (FRP) -fiber reinforced
...
pressure bonding - Properties - thermal- mechanical- electrical chemical ceramic fibres -
ferroelectric - ferromagnetic ceramics - High Aluminium ceramics. `;

let unit_text5 = ` Seismology - Seismic waves - Earth quake ground motion - Basic concepts - estimation
techniques - site effects - Probabilistic - deterministic Seismic hazard analysis - Cyclone - flood
hazards - Fire hazards - fire protection- fire-proofing of materials- fire safety regulations -
firefighting equipment - Prevention - safety measures `;
