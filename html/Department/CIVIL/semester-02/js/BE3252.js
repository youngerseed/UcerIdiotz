...
let unit_text1 = ` DC Circuits - Circuit Components -  Conductor, Resistor, Inductor, Capacitor - Ohm’s Law - Kirchhoff’s
Laws - Simple problems- Nodal Analysis -  Mesh analysis with Independent sources -
...
circuits - Three phase supply - star and delta connection - power in threephase systems `;

let unit_text2 = ` Magnetic circuits-definitions - MMF - flux -reluctance - magnetic field intensity- flux density -  fringing-
...
circuit breaker-moulded case circuit breaker- earth leakage circuit breaker- safety precautions -
`;

let unit_text3 = ` Construction and Working principle- DC Separately Self excited Generators- EMF equation-
Types and Applications - Working Principle of DC motors- Torque Equation- 
  Applications of Transformer- Three phase Alternator-
Synchronous motor- Three Phase Induction Motor. `;

let unit_text4 = ` Resistor- Inductor and Capacitor in Electronic Circuits- Semiconductor Materials - Silicon
&Germanium - PN Junction Diodes- Zener Diode -Characteristics Applications - Bipolar Junction
Transistor-Biasing- JFET- SCR- MOSFET-IGBT - 
Rectifier - Inverters - harmonics `;

let unit_text5 = ` Sensors- solenoids- pneumatic controls with electrical actuator- mechatronics- types of valves and
