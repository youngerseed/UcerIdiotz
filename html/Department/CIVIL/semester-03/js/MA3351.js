...
let unit_text1 = `partial differential equations - first order partial differential
equations - First order partial differential equations reducible to standard types- Lagrange's linear
equation - second and higher order Equations -coefficients
differential equations homogeneous - differential equations non homogeneous types. `;

let unit_text2 = ` Dirichlet's conditions - General Fourier series - Odd and even functions - Half range sine series
and cosine series - Root mean square value - Parseval's identity - Harmonic analysis. `;

let unit_text3 = ` Classification of PDE - Method of separation of variables - Fourier series solutions of one
dimensional wave equation - One dimensional equation of heat conduction - Steady state solution
of two dimensional equation of heat conduction  `;

let unit_text4 = ` Statement of Fourier integral theorem- Fourier transform pair - Fourier sine and
cosine transforms - Properties - Transforms of simple functions - Convolution theorem - Parseval's
identity. `;

let unit_text5 = ` Z transforms - Elementary properties - Convergence of Z transforms - - Initial and final value
