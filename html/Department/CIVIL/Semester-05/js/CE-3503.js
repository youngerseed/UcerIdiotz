...
let unit_text1 = "Scope and objectives - Methods of exploration - Auguring and boring - Wash boring rotary drilling - Depth spacing of bore holes - Soil samples - Representative  undisturbed - Sampling methods - Split spoon sampler- Thin wall sampler- Stationary piston sampler - Penetration tests (SPT  SCPT) - Data interpretation - Strength parameters  Evaluation - Liquefaction potential- Bore log report";

let unit_text2 = "Introduction - Location  depth of foundation - Codal provisions - Bearing  - Terzaghi's formula  BIS formula - Factors affecting bearing capacity - Bearing capacity from  (SPT- SCPT  plate load) - Allowable bearing pressure - Seismic considerations in bearing capacity evaluation- Determination of Settlement -foundations on granular  clay deposits - Total  differential settlement - Allowable settlements - Codal provision - Methods of minimizing - total  differential settlements";

let unit_text3 = "Types of Isolated footing- Combined footing- Mat foundation - Contact pressure  settlement distribution  - Minimum depth for rigid behaviour - Applications - Floating foundation - Special foundations - Seismic force consideration - Codal provision "

let unit_text4 = `Types of piles  their functions - Factors influencing  selection of pile - Carrying capacity of single pile in granular - cohesive soil - Static formula - Dynamic formulae (Engineering news 
Hileys) - Capacity from insitu tests (SPT- SCPT) - Negative skin friction - Uplift capacity- Group
capacity by different methods -Field's rule- Converse - Labarra formula-  block failure criterion -
Settlement of pile groups - Interpretation of pile load test - Under reamed piles -
Capacity under compression  uplift - Codal provision.  `;

let unit_text5 = ` Plastic equilibrium in soils - Active  passive states - Rankine's theory - Cohesionless 
...
line load - Stability analysis of retaining walls - Codal provision`;
