...
let unit_text1 = "Determinate  indeterminate trusses - analysis of determinate trusses - method of joints - method of sections - Deflections of pin jointed plane frames - lack of fit - change in temperature method of tension coefficient - Application to space trusses";

let unit_text2 = "Slope deflection equations - Equilibrium conditions - Analysis of continuous beams and rigid frames - Rigid frames with inclined members - Support settlements - symmetric frames with symmetric - skew symmetric loadings";

let unit_text3 = "Stiffness - distribution and carry over factors - Analysis of continuous Beams- Plane rigid frames with  sway- Plane rigid without sway - Support settlement - symmetric frames with symmetric - skew symmetric loadings "

let unit_text4 = "Primary structures - Compatibility conditions - Formation flexibility matrices - Analysis of indeterminate pin- jointed plane frames- continuous beams -rigid jointed plane frames by direct flexibility approach  ";

let unit_text5 = "Restrained structure -Formation of stiffness matrices - equilibrium condition - Analysis of Continuous Beams-Pin-jointed plane frames -  rigid frames by direct stiffness method.";
