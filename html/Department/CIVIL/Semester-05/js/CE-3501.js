...
let unit_text1 = "Concept of Elastic method ultimate load method -limit state method - Working stress method asdetailed in IS code - Design of Singly Reinforced beam by working stress method - Limit Statephilosophy as detailed in IS code - Advantages of Limit State Method over other methods - Analysisand design of singly - doubly reinforced rectangular beams by limit State Method.";

let unit_text2 = "Analysis and design of flanged beams - Use of design aids for Flexure - Behaviour of RC members in bond and Anchorage- Behaviour of RC beams in shearand torsion - Design of RC members for combined bending-shear and torsion - serviceability";

let unit_text3 = "Analysis and design of cantilever - Types of Staircases - Design of dog legged Staircase -Introduction to Flat Slab";

let unit_text4 = " Types of columns - Design of short Rectangular - circular columns for axial-circular columns for uniaxial- circular columns for  biaxial bending";

let unit_text5 = "Design of wall footing - Design of axially - Design of eccentrically loaded rectangular pad - Design of eccentrically loaded sloped footings - Design of combined rectangular footing for two columns only";
