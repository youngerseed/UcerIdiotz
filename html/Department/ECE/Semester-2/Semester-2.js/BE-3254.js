...
let unit_text1 = `Introduction to tansformer - Ideal and Practical Transformer - Phasor diagram - Per Unit System - Equivalent circuit - Testing - Efficiency and Voltage Regulation - Three Phase Transformers - Three Phase Transformers Applications - Auto Transformers Advantages - Harmonics.`;

let unit_text2 = `Introduction dc machines - Constructional Features - Motor and Generator mode - EMF and Torque equation - Circuit Model - Methods of Excitation - Characteristics - Starting and Speed Control - Universal Motor- Stepper Motors - Brushless DC Motors- Applications`;

let unit_text3 = `Principle of operation of three - phase induction motors - Construction - Construction Types - Equivalent circuit - Speed Control - Single phase Induction motors - Construction Types -starting methods.
Alternator Working principle - Equation of induced EMF - Voltage regulation - Synchronous
motors- working principle - starting methods - Torque equation.`;

let unit_text4 = `Functional elements of an instrument - Standards and calibration - Operating Principle - Operating Principle types - Moving Coil meters - Moving Iron meters - Measurement of three phase power - Energy Meter - Instrument Transformers - CT and PT , DSO - Block diagram- Data acquisition.`;

let unit_text5 = `Power system structure - Generation - Transmission and distribution - Various voltage levels,
Earthing - methods of earthing - protective devices - switch fuse unit - Miniature circuit breakermoulded case circuit breaker- earth leakage circuit breaker - safety precautions and First Aid`;
