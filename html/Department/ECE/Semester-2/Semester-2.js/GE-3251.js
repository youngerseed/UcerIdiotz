...
let unit_text1 = `Basic Geometrical constructions - Conics - Construction of ellipse - Construction of parabola - Construction of hyperbola by eccentricity method - Construction of cycloid - construction of
involutes of square and circle - Drawing of tangents and normal to the above curves.`;

let unit_text2 = `Orthographic projection principles - Principal planes - First angle projection - projection of points - Projection of straight lines - inclined to both the principal planes-
Determination of true lengths - true inclinations by rotating line method and traces. Projection of
planes - inclined to both the principal planes by rotating object
method.`;

let unit_text3 = `Projection of simple solids prisms - Projection of simple solids pyramids - Projection of simple solids cylinder - Projection of simple solids cone - Projection of simple solids truncated solids -
...
let unit_text4 = `Development of surfaces of simple & sectioned solids Prisms - Development of surfaces of simple & sectioned solids pyramids - Development of surfaces of simple & sectioned solids cylinders - Development of surfaces of simple & sectioned solids cones.`;

let unit_text5 = `Principles of isometric projection - isometric scale - lsometric projections of simple solids and truncated solids - Prisms - pyramids - cylinders - cones - combination of two solid objects in simple vertical positions - Perspective projection of simple solids Prisms - Perspective projection of simple solids pyramids - Perspective projection of simple solids cylinders by visual ray method.`;
