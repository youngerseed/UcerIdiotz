...
let unit_text1 = `Advertisements - Product Descriptions -Audio / video - Marketing a product - Persuasive Speech Techniques - Reading advertisements - user manuals - brochures - Professional emails - Email etiquette - Compare and Contrast Essay - Grammar - Mixed Tenses - Prepositional phrases Vocabulary - Contextual meaning of words`;

let unit_text2 = `Listening to longer technical talks and completing - gap filling exercises - Listening
technical information from podcasts - Describing news reports - Reading longer technical texts - Cause and Effect Essays - and Letters / emails of
complaint - Writing responses to complaints - Grammar - Active Passive Voice transformations - Infinitive and Gerunds Vocabulary - Word Formation - Adverbs.`;

let unit_text3 = `Listening Watching movie scenes-  Speaking - Group Discussion - techniques and Strategies -
Reading - Case Studies- excerpts from literary texts- news reports -
...
let unit_text4 = `Listening - Listening Comprehension based on news reports - documentaries - Precis writing - Summarising - Speaking  - Interviewing - Presenting an oral report - Reading - Newspaper articles - Writing - Recommendations - Transcoding - Accident Report - Survey
Report Grammar  - Reported Speech-  Modals Vocabulary - Conjunctions - use of prepositions`;

let unit_text5 = `Listening - Listening to TED Talks - Presentations - Formal job interviews - Speaking - Participating in a Role play - virtual interviews - Making presentations with visual aids - Reading  - Company profiles - Statement of Purpose - Writing - Job / Internship application - Cover letter & Resume - Grammar - Numerical adjectives - Relative Clauses Vocabulary  - Idioms.`;
