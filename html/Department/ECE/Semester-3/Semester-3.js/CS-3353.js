...
let unit_text1 = `Data Types - Variables - Operations - Expressions and Statements - Conditional Statements -
Functions - Recursive Functions - Arrays - Single Dimensional Arrays - Multi Dimensional Arrays.`;

let unit_text2 = `Structures - Union - Enumerated Data Types - Pointers - Pointers to Variables - Arrays - Functions - File Handling - Preprocessor Directives.`;

let unit_text3 = `Abstract Data Types (ADTs) - List ADT - Array-Based Implementation - Linked List - Doubly- Linked Lists - Circular Linked List - Stack ADT - Implementation of Stack - Applications - Queue ADT -
Priority Queues - Queue Implementation - Applications.`;

let unit_text4 = `Trees - Binary Trees - Tree Traversals - Expression Trees - Binary Search Tree - Hashing - Hash Functions - Separate Chaining - Open Addressing - Linear Probing - Quadratic Probing - Double
Hashing - Rehashing.`;
