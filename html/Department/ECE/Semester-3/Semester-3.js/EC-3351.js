...
let unit_text1 = `Control System Terminology - Control System Basic Structure - Feed forward and Feedback control theory - Electrical Transfer Function Models - Mechanical Transfer Function Models - Block diagram Models - Signal flow graphs models - DC servo Systems Synchronous - AC servo Systems Synchronous - Multivariable control system`;

let unit_text2 = `Transient response - steady state response - Measures of performance of the standard first order - second order system - effect on an additional zero - an additional pole steady error constant and system- type number - PID control - Analytical design for PD - Analytical design for PI - Analytical design for PID control systems`;

let unit_text3 = `Closed loop frequency response - Performance specification in frequency domain - Frequency response of standard second order system - Bode Plot - Polar Plot - Nyquist plots - Design of compensators using Bode plots - Cascade lead compensation - Cascade lag compensation - Cascade lag lead compensation`;

let unit_text4 = `Concept of stability - Bounded - Input Bounded - Output stability - Routh stability criterion - Relative stability - Root locus concept - Guidelines for sketching root locus - Nyquist stability criterion.`;

let unit_text5 = `State variable representation - Conversion of state variable models to transfer functions - Conversion of transfer functions to state variable models - Solution of state equations - Concepts of Controllability - concepts of Observability - Stability of linear systems - Equivalence between transfer function and state variable representations - State variable analysis of digital control system - Digital control design using state feedback`;
