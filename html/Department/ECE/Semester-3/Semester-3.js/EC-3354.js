...
let unit_text1 = `Standard signals Step - Standard signals Ramp - Standard signals Pulse - Standard signals Impulse - Standard signals Real - Standard signals complex - exponentials - Sinusoids - Classification of signals Continuous time (CT) - Classification of signals Discrete Time (DT) - Classification of signals Periodic & Aperiodic signals - Classification of signals Deterministic & Random signals - Classification of signals Energy & Power signals - Classification of systems CT systems - Classification of systems DT systems - Classification of systems  Linear & Nonlinear - Classification of systems Time-variant& Time-invariant - Classification of systems Causal & Non-causal - Classification of systems Stable & Unstable.`;

let unit_text2 = `Fourier series for periodic signals - Fourier Transform - Fourier Transform properties - Laplace Transforms and Properties`;

let unit_text3 = `Impulse response - convolution integrals - Differential Equation - Fourier and Laplace transforms in Analysis of CT systems - Systems connected in series / parallel.`;

let unit_text4 = `Baseband signal Sampling - Fourier Transform of discrete time signals (DTFT) - Properties of DTFT  - Z Transform & Properties`;

let unit_text5 = `Impulse response - Difference equations - Convolution sum - Discrete Fourier Transform - Z Transform - Analysis of Recursive - Non-Recursive - systems DT - systems connected in series - systems connected in parallel.`;
