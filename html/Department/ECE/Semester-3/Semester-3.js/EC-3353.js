...
let unit_text1 = `PN junction diode - Zener diode - BJT structure - MOSFET structure - UJT structure - operation and V-I characteristics - diffusion capacitance - transition capacitance - Rectifiers - Half Wave Rectifier - Full Wave Rectifier - Zener as regulator`;

let unit_text2 = `Load line - operating point - biasing methods for BJT - biasing methods for MOSFET - BJT small signal model - Analysis of CE amplifiers - Analysis of CB amplifiers - Analysis of CC amplifiers - Gain and frequency response - MOSFET small signal model - Analysis of CS - Analysis of CG - Analysis of Source follower - Gain and frequency response - High frequency analysis.`;

let unit_text3 = `Cascode amplifier - Differential amplifier  - Common mode analysis - Difference mode analysis - MOSFET input stages - tuned amplifiers - Gain and frequency response - Neutralization methods.`;

let unit_text4 = `Advantages of negative feedback - Voltage / Current - Series feedback - Shunt feedback Amplifiers - positive feedback - Condition for oscillations - phase shift - Wien bridge - Hartley - Colpitts oscillators - Crystal oscillators.`;

let unit_text5 = `Power amplifiers - class A Class - B Class - AB Class - C Power - MOSFET - Temperature Effect- Class AB Power amplifier using MOSFET - DC/DC convertors - Buck analysis and design - Boost analysis and design - Buck-Boost analysis and design.`;
