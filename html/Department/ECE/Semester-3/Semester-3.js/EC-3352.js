...
let unit_text1 = `Review of number systems - Review of representation - Review of conversions - Review of Boolean algebra - theorems - sum of product simplification - product of sum simplification - canonical forms min term - canonical forms max term - Simplification of Boolean expressions - Karnaugh map - completely specified functions - incompletely specified functions - Boolean expressions using universal gates - Tabulation methods.`;

let unit_text2 = `Problem formulation - design of combinational circuits - Code Converters - Half Adders - Full Adders - Binary Parallel Adder - Carry look ahead Adder - BCD Adder - Magnitude Comparator - Decoder - Encoder - Priority Encoder - Mux/Demux - Case study Digital trans receiver - Case study 8 bit Arithmetic - Case study logic unit - Parity Generator/Checker - Seven Segment display decoder`;

let unit_text3 = `Latches - Flip flops SR - Flip flops JK - Flip flops T - Flip flops D - Master/Slave FF - Triggering of FF - Analysis and design of clocked sequential circuits - Design Moore/Mealy models - state minimization - state assignment - lock out condition circuit implementation - Counters - Ripple Counters - Ring Counters - Shift registers - Universal Shift Register - Model Development Designing of rolling display- Model Development real time clock`;

let unit_text4 = `Stable and Unstable states - output specifications - cycles and races - state reduction - race free assignments - Hazards - Essential Hazards - Fundamental sequential circuits - Pulse mode sequential circuits - Design of Hazard free circuits.`;

let unit_text5 = `Logic families - Propagation Delay - Fan In and Fan - Noise Margin RTL - Noise Margin TTL - Noise Margin ECL - Noise Margin CMOS - Comparison of Logic families - sequential logic design using standard ICs - sequential logic design using standard PROM - sequential logic design using standard PLA - sequential logic design using standard PAL - basic memory - static ROM - static PROM - static EPROM - static EEPROM - static EAPROM.`;
