...
let unit_text1 = `Sampling Theorem - concept of frequency in discrete time signals - summary of analysis & synthesis equations for FT & DTFT - frequency domain sampling - Discrete Fourier transform (DFT) - deriving
...
let unit_text2 = `Characteristics of practical frequency selective filters - characteristics of commonly used analog filters - Butterworth filters - Chebyshev filters - Design of IIR filters from analog filter - Approximation of derivatives - Impulse invariance method - Bilinear transformation - Frequency 
transformation in the analog domain - Structure of IIR filter - direct form I - direct form II - Cascade -
parallel realizations`;

let unit_text3 = `Design of FIR filters - symmetric and Anti symmetric FIR filters - design of linear phase FIR filters using Fourier series method - FIR filter design using windows (Rectangular, Hamming and Hanning
window)- Frequency sampling method- FIR filter structures - linear phase structure- direct form
realizations`;

let unit_text4 = `Fixed point - floating point number representation - ADC - quantization - truncation and rounding - quantization noise - input / output quantization - coefficient quantization error - product
...
let unit_text5 = `Multirate signal processing Decimation - Multirate signal processing Interpolation - Sampling rate conversion by a rational factor - Adaptive Filters Introduction - Adaptive Filters Applications of adaptive filtering to equalization - DSP ArchitectureFixed - Floating point architecture principles`;
