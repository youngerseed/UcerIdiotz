...
let unit_text1 = "General theory of Transmission lines - the transmission line - general solution - The infinite line - Wavelength- velocity of propagation - Waveform distortion - the distortion less line - Loading and different methods of loading - Line not terminated in Z 0 - Reflection coefficient - calculation of current-calculation of voltage-calculation of power -calculation of delivered -calculation of efficiency of transmission - Input and transfer impedance - Open and short circuited lines - reflection factor and reflection loss.";

let unit_text2 = "Transmission line equations at radio frequencies - Line of Zero dissipation - Voltage and current on the dissipation less line- Standing Waves- Nodes- Standing Wave Ratio - Input impedance of the dissipation less line - Open and short circuited lines - Power and impedance measurement on lines - Reflection losses - Measurement of VSWR and wavelength.";

let unit_text3 = "Impedance matching Quarter wave transformer -Impedance matching One Eighth wave line-Impedance matching Half wave line- Impedance matching by stubs- Single stub and double stub matching - Smith chart - Application of Smith chart- Solutions of problems using Smith chart- Single and double stub matching using Smith chart.";

let unit_text4 = "Waves between parallel planes of perfect conductors- Transverse Electric waves and Transverse Magnetic waves- Characteristics of TE waves-Characteristics of TM waves- Transverse Electromagnetic waves- TM and TE waves in Rectangular waveguides- TM and TE waves in Circular waveguides.";

let unit_text5 = "Active RF components Semiconductor basics in RF - Active RF components bipolar junction transistors -Active RF components RF field effect transistors -Active RF components High electron mobility transistors -Active RF components Fundamentals of MMIC - Basic concepts of RF design Filters -RF design couplers - RF design power dividers -RF design Amplifier power relations -RF design Low noise amplifiers -RF design Power amplifiers.";
