...
let unit_text1 = `Microcontrollers for an Embedded System - Microcontrollers 8051 - Microcontrollers for an embedded system Architecture - Microcontrollers for an Embedded System Addressing Modes -  Microcontrollers for an Embedded System Instruction Set - Microcontrollers for an Embedded System Program and Data Memory - Microcontrollers for an Embedded System Stacks - Microcontrollers for an Embedded System Interrupts - Microcontrollers for an Embedded System Timers/Counters - Microcontrollers for an Embedded System Serial Ports -microcontrollers for an Embedded System Programming.`;

let unit_text2 = `Embedded System Design Process - Model Train Controller - ARM Processor - Instruction Set
...
let unit_text3 = `Structure of a real - time system - Task Assignment and Scheduling - Multiple Tasks and Multiple Processes - Multirate Systems - Pre emptive real - time Operating systems - Priority based
...
let unit_text4 = `Internet of Things Physical Design - Logical Design - IoT Enabling Technologies - Domain
Specific IoTs - IoT and M2M - IoT System Management with NETCONF -iot YANG - IoT Platform
Design - Methodology - IoT Reference Model - Domain Model - Communication Model - IoT
Reference Architecture - IoT Protocols MQTT - IoT Protocols XMPP - IoT Protocols Modbus - IoT Protocols CANBUS - IoT Protocols BACNet.`;

let unit_text5 = `Basic building blocks of an IoT device - Raspberry Pi - Board - Linux on Raspberry Pi - Interfaces - Programming with Python - Case Studies Home Automation - Case Studies Smart Cities -Case Studies  Environment - Case Studies Agriculture.`;
