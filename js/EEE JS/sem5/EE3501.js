...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = " Need for system planning and operational studies- Power scenario in India- Power system components, Representation- Single line diagram- per unit quantities- p.u. impedance diagram- p.u. reactance diagram- Network graph Theory- Bus incidence matrices- Primitive  parameters- Formation of bus admittance matrix- Direct inspection method- Singular Transformation method. ";
  
  let unit_text2 = "Bus classification- Formulation of Power Flow problem in polar coordinates- Power flowsolution-  using Gauss Seidel method- Handling of Voltage controlled buses- Power FlowSolution by Newton Raphson method- Flow charts- Comparison of methods.";
  
  let unit_text3 = " Assumptions in short circuit analysis - Symmetrical short-  circuit analysis using Thevenin’s theorem - Bus Impedance matrix building algorithm (without mutual coupling) - Symmetrical fault analysis through bus impedance matrix - Post fault bus voltages - Fault level - Current limiting reactors";
  
  let unit_text4 = " Symmetrical components - Sequence impedances - Sequence networks - Analysis of unsymmetrical faults-  at generator terminals LG LL and LLG - unsymmetrical fault occurring at any point in a power system ";
