...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = " Control system - Open loop and Closed loop- Feedback control system characteristics- First principle modeling- Mechanical Electrical and Electromechanical systems- Transfer function representations- Block diagram and Signal flow graph. ";
  
  let unit_text2 = "Standard test inputs - Time response - Time domain specifications - Stability analysis: Concept of  stability - Routh Hurwitz stability criterion - Root locus: Construction and Interpretation- Effect of  adding poles and zeros";
  let unit_text3 = "Bode plot- Polar plot and Nyquist plot- Frequency domain specifications- Introduction to closed loop  Frequency Response- Effect of adding lag- lead compensators ";
  
  let unit_text4 = "State variable formulation - Non uniqueness of state space model - State transition matrix -Eigen  values - Eigen vectors - Free and forced responses- Time Invariant and Time Varying Systems -  Controllability - Observability ";
  
  let unit_text5 = "Design specifications - Lead Lag and Lag-lead compensators- Root locus and Bode plot  techniques -PID controller - Design using reaction curve-  Ziegler-Nichols technique- PID control  in State Feedback form.";
