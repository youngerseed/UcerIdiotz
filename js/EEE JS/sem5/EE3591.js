...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = " MOSFET dynamic behavior - driver and snubber circuits - low power high switching frequency-  switching Power supplies buck boost buck-boost converters - Isolated topologies - resonant  converters - switching loss calculations and thermal design. ";
  
  let unit_text2 = "IGBT- Static and dynamic behavior- single phase half bridge- full bridge inverters- VSI (1phase   and three phase inverters square wave operation)- Voltage control of inverters single, multi pulse-    sinusoidal space vector modulation techniques- various harmonic elimination techniques-CSI";
  let unit_text3 = "Power Diode - half wave rectifier - mid point secondary transformer based full wave rectifier - bridge  rectifier - voltage doubler circuit - distortion factor - capacitor filter for low power rectifiers - LC filters  - Concern for power quality - three phase diode bridge";
  
  let unit_text4 = " SCR-Two transistor analogy based turn- ON  turn ON losses - thermal protection - controlled  converters (1 pulse, 2 pulse, 3 pulse, 6 pulse) - displacement factor - ripple and harmonic factor -  power factor mitigation, performance parameters - effect of source inductance - inverter angle limit.";
  
  let unit_text5 = "TRIAC triggering concept- positive and negative gate pulse triggering- TRIAC based phase controllers - various configurations for SCR-  based single and three phase controllers.";
