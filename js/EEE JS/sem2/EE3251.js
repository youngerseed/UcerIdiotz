...
let unit_text1 = " Fundamentals concepts of R, L and C elements-Energy Sources- Ohms Law -Kirchhoff s Laws -DCCircuits -Resistors in series and parallel circuits - A.C Circuits -Average and RMS Value -Complex Impedance -Phasor diagram - Real and Reactive Power-Power Factor Energy -Meshcurrent and node voltage methods of analysis - D.C and A.C Circuits.  ";

let unit_text2 = "Network reduction -  voltage and current division - source transformation -star delta conversion - Theorems -Superposition - Thevenin’s and Norton’s Theorem -Maximum power transfer theorem -Reciprocity Theorem -Millman's theorem- Tellegen’s Theorem Statement -  application to DC and ACCircuits. ";

let unit_text3 = "Introduction  Laplace transforms - and inverse Laplace transforms- standard test signals -Transientresponse of RL, RC and RLC circuit s-  Laplace transform for Source free -  Step input - Sinusoidal input. ";

let unit_text4 = "Series and parallel resonance -frequency response-Quality factor and Bandwidth-Self and mutualinductance-Coefficient of coupling-Dot rule-Analysis of coupled circuits-Single Tuned circuits. ";

let unit_text5 = "Analysis of three phase 3 - wire and 4 wire circuits -  star and delta connected loads - balanced andunbalanced -phasor diagram of voltages and currents -power measurement in three phase circuits - Power Factor Calculations";
...
Unit_loop_function(unit_text3 , unit_03_color , 3);g
