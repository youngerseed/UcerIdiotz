...
const videoText_u71 = document.getElementById("video-text_u71");
const english_u71 = document.getElementById("english_u71")
const videoIframeContainer_u71 = document.getElementById("video-iframe-container_u71");
const video_english_u71=document.getElementById('video-iframe-english_u71');
const video_tamil_u71=document.getElementById('video-iframe_u71');

videoText_u71.addEventListener("click", function() {
  if (videoIframeContainer_u71.style.display === "none") {
    videoIframeContainer_u71.style.display = "block";
    unit_div.classList.add("unit-div-2");
    videoIframeContainer_u71.classList.remove("hoverback");
  } else {
    unit_div.classList.remove("unit-div-2");
    videoIframeContainer_u71.classList.add("hoverback");
    setTimeout(function(){
     videoIframeContainer_u71.style.display = "none";
    },1000)
  }
});
...
const videoText_u72 = document.getElementById("video-text_u72");
const english_u72 = document.getElementById("english_u72")
const videoIframeContainer_u72 = document.getElementById("video-iframe-container_u72");
const video_english_u72=document.getElementById('video-iframe-english_u72');
const video_tamil_u72=document.getElementById('video-iframe_u72');

videoText_u72.addEventListener("click", function() {
  if (videoIframeContainer_u72.style.display === "none") {
    videoIframeContainer_u72.style.display = "block";
    unit_div.classList.add("unit-div-2");
    videoIframeContainer_u72.classList.remove("hoverback");
  } else {
    unit_div.classList.remove("unit-div-2");
    videoIframeContainer_u72.classList.add("hoverback");
    setTimeout(function(){
     videoIframeContainer_u72.style.display = "none";
    },1000)
  }
});


const videoText_u73 = document.getElementById("video-text_u73");
const english_u73 = document.getElementById("english_u73")
const videoIframeContainer_u73 = document.getElementById("video-iframe-container_u73");
const video_english_u73=document.getElementById('video-iframe-english_u73');
const video_tamil_u73=document.getElementById('video-iframe_u73');

videoText_u73.addEventListener("click", function() {
  if (videoIframeContainer_u73.style.display === "none") {
    videoIframeContainer_u73.style.display = "block";
    unit_div.classList.add("unit-div-2");
    videoIframeContainer_u73.classList.remove("hoverback");
  } else {
    unit_div.classList.remove("unit-div-2");
    videoIframeContainer_u73.classList.add("hoverback");
    setTimeout(function(){
     videoIframeContainer_u73.style.display = "none";
    },1000)
  }
});


const videoText_u74 = document.getElementById("video-text_u74");
const english_u74 = document.getElementById("english_u74")
const videoIframeContainer_u74 = document.getElementById("video-iframe-container_u74");
const video_english_u74=document.getElementById('video-iframe-english_u74');
const video_tamil_u74=document.getElementById('video-iframe_u74');

videoText_u74.addEventListener("click", function() {
  if (videoIframeContainer_u74.style.display === "none") {
    videoIframeContainer_u74.style.display = "block";
    unit_div.classList.add("unit-div-2");
    videoIframeContainer_u74.classList.remove("hoverback");
  } else {
    unit_div.classList.remove("unit-div-2");
    videoIframeContainer_u74.classList.add("hoverback");
    setTimeout(function(){
     videoIframeContainer_u74.style.display = "none";
    },1000)
  }
});

const videoText_u75 = document.getElementById("video-text_u75");
const english_u75 = document.getElementById("english_u75")
const videoIframeContainer_u75 = document.getElementById("video-iframe-container_u75");
const video_english_u75=document.getElementById('video-iframe-english_u75');
const video_tamil_u75=document.getElementById('video-iframe_u75');

videoText_u75.addEventListener("click", function() {
  if (videoIframeContainer_u75.style.display === "none") {
    videoIframeContainer_u75.style.display = "block";
    unit_div.classList.add("unit-div-2");
    videoIframeContainer_u75.classList.remove("hoverback");
  } else {
    unit_div.classList.remove("unit-div-2");
    videoIframeContainer_u75.classList.add("hoverback");
    setTimeout(function(){
     videoIframeContainer_u75.style.display = "none";
    },1000)
  }
});
