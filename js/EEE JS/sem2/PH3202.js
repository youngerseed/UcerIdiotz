...
let unit_text1 = " Matter polarization and relative permittivity definition - dipole moment and polarization vector - Ppolarization mechanisms - electronic, ionic, orientational, interfacial and total polarization - frequencydependence - local field and Causius-Mossetti equation - dielectric constant and dielectric loss -Gaus law and boundary conditions - dielectric strength, introduction to insulation breakdown ingases, liquids and solids - capacitor materials - typical capacitor constructions - piezoelectricity,ferroelectricity and pyroelectricity - quartz oscillators and filters - piezo and pyroelectric crystals ";

let unit_text2 = "Classical free electron theory - Expression for electrical conductivity -Thermal conductivity,expression - Quantum free electron theory :Tunneling -degenerate states -Fermi- Dirac statistics - Density of energy states -Electron in periodic potential -Energy bands in solids -tight bindingapproximation - Electron effective mass -concept of hole. Magnetic materials: Dia, para andferromagnetic effects -paramagnetism in the conduction electrons in metals -exchange interactionand ferromagnetism -quantum interference devices -GMR devices";

let unit_text3 = "Intrinsic Semiconductors - Energy band diagram - direct and indirect band gap semiconductors -Carrier concentration in intrinsic semiconductors - extrinsic semiconductors - Carrier concentration inN-type & P-type semiconductors - Variation of carrier concentration with temperature - Carriertransport in Semiconductors: Drift, mobility and diffusion - Hall effect and devices - Ohmic contacts -Schottky diode. ";

let unit_text4 = "Classification of optical materials - Optical processes in semiconductors - optical absorption andemission - charge injection and recombination optical absorption loss and gain Optical processes inquantum wells - Optoelectronic devices light detectors and solar cells - light emitting diode - laserdiode - optical processes in organic semiconductor devices -excitonic state - Electro-optics andnonlinear optics Modulators and switching devices - plasmonics.  ";
