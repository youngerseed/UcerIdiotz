...
let unit_text1 = "Constructional details - Types of rotors -winding factors- EMF equation - Synchronous reactance -Armature reaction - Phasor diagrams of non-salient pole synchronous generator connected to infinitebus--Synchronizing and parallel operation - Synchronizing torque -Change of excitation andmechanical input- Voltage regulation - EMF  MMF  ZPF and A.S.A method - steady state powerangle characteristics- Two reaction theory -slip test -short circuit transients - Capability Curves";

let unit_text2 = " Principle of operation - Torque equation - Operation on infinite bus bars - V and Inverted V curves -Power input and power developed equations - Starting methods - Current loci for constant powerinput, constant excitation and constant power Developed-Hunting - natural frequency of oscillations -damper windings- synchronous condenser.";

let unit_text3 ="Constructional details - Types of rotors -- Principle of operation - Slip -cogging and crawlingEquivalent circuit - Torque-Slip characteristics - Condition for maximum torque - Losses andefficiency - Load test - No load and blocked rotor tests - Circle diagram - Separation of losses -Double cage induction motors -Induction generators - Synchronous induction motor.";

let unit_text4 = "Need for starting - Types of starters - DOL, Rotor resistance, Autotransformer and Star delta starters- Speed control - Voltage control, Frequency control and pole changing - Cascaded Connection-V/fcontrol - Slip power recovery Scheme-Braking of three phase induction motor: Plugging, dynamicbraking and regenerative braking.";

let unit_text5 = "Constructional details of single phase induction motor - Double field revolving theory and operation -Equivalent circuit - No load and blocked rotor test - Performance analysis - Starting methods ofsingle-phase induction motors - Capacitor-start capacitor run Induction motor- Shaded pole inductionmotor - Linear induction motor - Repulsion motor - Hysteresis motor - AC series motor- Servo motorsStepper motors - introduction to magnetic levitation systems.";
