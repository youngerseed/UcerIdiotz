...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = "Functional block diagram - Memory interfacing-I/O ports and data transfer concepts - Timing Diagram - Interrupt structure.";
  
  let unit_text2 = "Instruction format and addressing modes - Assembly language format - Data transfer, data manipulation & control instructions - Programming: Loop structure with counting & Indexing - Look up  table - Subroutine instructions stack ";
  
  let unit_text3 ="Study of Architecture and programming of ICs- 8255 PPI- 8259PIC- 8251USART- 8279 Keyboard display controller and 8254 Timer/Counter - Interfacing with 8085 -A/D and D/A converter interfacing";
  
  let unit_text4 = "Functional block diagram - Instruction format and addressing modes - Interrupt structure - Timer - I/O  ports - Serial communication, Simple programming -keyboard and display interface - Temperature control system -stepper motor control - Usage of IDE for assembly language programming. ";
  
  let unit_text5 = "PIC16 /18 architecture, Memory organization - Addressing modes - Instruction set - Programming techniques - Timers - I/O ports - Interrupt programm";
