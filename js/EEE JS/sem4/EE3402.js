...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = "IC classification, fundamental of monolithic IC technology- epitaxial growth- masking and etching-  diffusion of impurities- Realisation of monolithic ICs and packaging- Fabrication of diodes- capacitance  resistance- FETs and PV Cell.";
  
  let unit_text2 = "Ideal OP-AMP characteristics, DC characteristics- AC characteristics- differential amplifier- frequency  response of OP-AMP- Voltage-shunt feedback and inverting amplifier - Voltage series feedback-  Non-Inverting Amplifier - Basic applications of op-amp - summer differentiator and Integrator-V/I & I/V  converters";
  
  let unit_text3 ="Instrumentation amplifier and its applications for transducer Bridge- Log and Antilog Amplifiers- Analog  multiplier & Divider- first and second order active filters- comparators multi vibrators- waveform  generators clippers- clampers peak detector- S/H circuit, D/A converter (R- 2R ladder and weighted  resistor types)- A/D converters using OP-AMPs.";
  
  let unit_text4 = "Functional block- characteristics of 555 Timer and its PWM application - IC 566 voltage controlled  oscillator IC- 565-phase locked loop IC- AD633 Analog multiplier ICs.";
  
  let unit_text5 = "AD623 Instrumentation Amplifier and -its application as load cell weight measurement - IC voltage  regulators -LM78XX  LM79XX - Fixed voltage regulators its application as Linear power supply -  LM317 723 Variability voltage regulators- switching regulator- SMPS - ICL 8038 function generator  IC";
