...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = "Instruments classification applications - Elements of a generalized measurement system - Static and  dynamic characteristics - Errors in measurement -Statistical evaluation of measurement data.";
  
  let unit_text2 = "Classification of instruments- moving coil and moving iron meters- Induction type, dynamometer  type watt meters- Energy meter- Megger- Instrument transformers (CT & PT). ";
  
  let unit_text3 ="Wheatstone bridge- Kelvin double bridge - Maxwell Hay Wien and Schering bridges - Errors and  compensation in A.C. bridges - Instrumentation Amplifiers";
  
  let unit_text4 = "Classification of transducers - Measurement of pressure- temperature displacement flow angular  velocity - Digital transducers - Smart Sensors";
  
  let unit_text5 = "A/D converters- types and characteristics- Sampling, Errors- Measurement of voltage Current-  frequency and phase - D/A converters: types and characteristics- DSO- Data Loggers- Basics of PLC  programming and Introduction to Virtual Instrumentation - Instrument standards.";
