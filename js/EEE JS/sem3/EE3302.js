...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = "Number system- error detection- corrections and  codes conversions Boolean algebra- DeMorgans theorem- switching functions and minimization -using K-maps & Quine McCluskeymethod - Digital Logic Families -comparison of RTL DTL TTL ECL and MOS families -  operation characteristics of digital logic family. ";
  
  let unit_text2 = " Combinational logic - representation of logic functions-SOP and POS forms- K-maprepresentations - minimization using K maps - simplification and implementation ofcombinational logic - multiplexers and de multiplexers - code converters- adders subtractors Encoders and Decoders";
  
  let unit_text3 = "Sequential logic- SR JK D and T flip flops - level triggering and edge triggering - counters -  asynchronous and synchronous type - Modulo counters - Shift registers - design of  synchronous sequential circuits - Moore and Mealy models- Counters state diagram; state  reduction- state assignment";
  
  let unit_text4 = " Asynchronous sequential logic Circuits-Transition stability - flow stability race conditions-  hazards &errors in digital circuits- analysis of asynchronous sequential logic circuits -introduction to Programmability Logic Devices- PROM - PLA -PAL- CPLD-FPGA";
  
  let unit_text5 = "RTL Design - combinational logic - Sequential circuit - Operators - Introduction toPackages - Subprograms Test bench- (Simulation /Tutorial Examples adders counters  flip flops- Multiplexers & De multiplexers)";
