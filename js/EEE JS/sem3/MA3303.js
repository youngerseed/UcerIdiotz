...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = "Axioms of probability - Conditional probability - Bayes theorem - Discrete and continuous random  variables - Moments - Moment generating functions - Binomial Poisson Geometric Uniform-  Exponential and Normal distributions - Functions of a random variable.";
  
  let unit_text2 = "Joint distributions -Marginal and conditional distributions -Covariance -Correlation and linear  regression -Transformation of random variables -Central limit theorem (for independent -  identically distributed random variables).";
  
  let unit_text3 = "Analytic functions - Necessary and sufficient conditions - analyticity in Cartesian and polar  coordinates - Properties - Harmonic conjugates - Construction of analytic function - Conformal  mapping - Mapping by functions 1 2 zzw  z  c, cz, , - Bilinear transformation";
  
  let unit_text4 = " Line integral - Cauchys integral theorem - Cauchys integral formula - Taylors and Laurents series- Singularities - Residues - Residue theorem- Application of residue theorem for evaluation of realintegrals- Applications of circular contour and semicircular contour (with poles NOT on real axis). ";
  
  let unit_text5 = "Higher order linear differential equations - constant coefficients - Method of variation of parameters  - Homogenous equation of Eulers and Legendres type - System of simultaneous linear first order-  differential equations with constant coefficients - Method of undetermined coefficients";
