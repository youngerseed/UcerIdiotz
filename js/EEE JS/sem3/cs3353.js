...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = " Data Types - Variables - Operations - Expressions and Statements - Conditional Statements -Functions - Recursive Functions - Arrays - Single and Multi-Dimensional Arrays.  ";
  
  let unit_text2 = "Structures-Union-Enumerated Data Types-Pointers- Pointers to Variables, Arrays and Functions - File Handling-Preprocessor Directives ";
  
  let unit_text3 = " Abstract Data Types (ADTs) - List ADT - Array-Based Implementation - Linked List - Doubly- LinkedLists - Circular Linked List - Stack ADT - Implementation of Stack - Applications - Queue ADT -Priority Queues - Queue Implementation - Applications";
  
  let unit_text4 = " Trees - Binary Trees - Tree Traversals - Expression Trees - Binary Search Tree - Hashing - HashFunctions - Separate Chaining - Open Addressing - Linear Probing- Quadratic Probing - DoubleHashing - Rehashing.  ";
  
  let unit_text5 = "Insertion Sort - Quick Sort - Heap Sort - Merge Sort -Linear Search - Binary Search.";
