...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = "  PN junction diode -structure, operation and V-I characteristics, diffusion and transition capacitance -Clipping & Clamping circuits - Rectifiers - Half Wave and Full Wave Rectifier- Display devices- LED,Laser diodes, Zener diode characteristics- Zener diode Reverse characteristics - Zener diode asregulator ";
  
  let unit_text2 = "BJT- JFET- MOSFET- structure- operation characteristics and Biasing UJT- Thyristors and IGBT -Structure and characteristics. ";
  
  let unit_text3 = " BJT small signal model-Analysis of CE CB CC amplifiers- Gain and frequency response -MOSFETsmall signal model- Analysis of CS and Source follower-Gain and frequency response- Highfrequency analysis";
  
  let unit_text4 = " BIMOS cascade amplifier- Differential amplifier -Common mode and Difference mode analysis -FETinput stages -Single tuned amplifiers -Gain and frequency response -Neutralization methods,power amplifiers -Types (Qualitative analysis). ";
  
  let unit_text5 = "Advantages of negative feedback- voltage / current series- Shunt feedback-positive feedback-Condition for oscillations- phase shift- Wien bridge- Hartley Colpitts and Crystal oscillators.";
