...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = "Fundamentals of Magnetic circuits- Statically and dynamically induced EMF - Principle of  electromechanical energy -conversion forces and torque in magnetic field systems- energy balance in  magnetic circuits- magnetic force- co-energy in singly excited and multi excited magnetic field system  - of distributed windings - Winding Inductances- magnetic fields in rotating machines- magnetic  saturation and leakage fluxes- Introduction to Indian Standard Specifications (ISS) - Role and  significance in testing ";
  
  let unit_text2 = "Principle of operation- constructional details- armature windings and its types -EMF equation- wave  shape of induced emf- armature reaction- demagnetizing and cross magnetizing Ampere turns-  compensating winding- commutation methods of improving commutation interpoles- OCC and load  characteristics of different types of DC Generators- Parallel operation of DC Generators- equalizing  connections- applications of DC Generators";
  
  let unit_text3 = "Principle of operation- significance of back emf- torque equations and power developed by armature-  speed control of DC motors- starting methods of DC motors- load characteristics of DC motors- losses  and efficiency in DC machine- condition for maximum efficiency- Testing of DC Machines- Brake test,Swinburnes test- Hopkinson's test- Field test- Retardation test- Separation of core losses-applications of DC motors";
  
  let unit_text4 = " Construction and principle of operation- equivalent circuit phasor diagrams testing - polarity test -  open circuit and short circuit tests- voltage regulation, losses and efficiency- all day efficiency back-toback test- separation of core losses- parallel operation of single-phase transformers- applications of  single-phase transformer.";
  
  let unit_text5 = "Construction and working of auto transformer- comparison with two winding transformers- applicationsof autotransformer- Three Phase Transformer- Construction types of connections and theircomparative features- Scott connection- applications of Scott connection";
