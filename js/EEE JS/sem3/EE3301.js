...
function createDivision(unit_color,string,unitId,count){
  ...
  let unit_text1 = "`Electric potential -Electric field and equipotential plots- Uniform and Non-Uniform field- Utilizationfactor -Electric field in free space- conductors- dielectrics - Dielectric polarization -Dielectric strength -Electric field in multiple dielectrics -Boundary conditions  Poissons and Laplaces equations -Capacitance- Energy density Applications. ";
  
  let unit_text2 = "Lorentz force, magnetic field intensity (H) - Biot-Savarts Law - Amperes Circuit Law - H due tostraight conductors  circular loop - infinite sheet of current- Magnetic flux density (B) - B in free space conductor magnetic materials - Magnetization Magnetic field in multiple media -Boundary conditions scalar and vector potential- Poissons Equation- Magnetic force- Torque Inductance  -Energy density Applications ";
  
  let unit_text3 = " Magnetic Circuits - Faradays law-Transformer and motional EMF-Displacement current -Maxwellsequations (differential and integral form)-Relation between field theory and circuit theory Applications.";
  
  let unit_text4 = "Magnetic Circuits - Faradays law - Transformer and motional EMF - Displacement current -Maxwells  equations (differential and integral form) - Relation between field theory and circuit theory - Applications ";
  
  let unit_text5 = "Electromagnetic wave generation and equations - Wave parameters velocity- intrinsic impedance- propagation constant - Waves in free space- lossy and lossless dielectrics conductors- skin depth -  Poynting vector - Plane wave reflection and refraction";
